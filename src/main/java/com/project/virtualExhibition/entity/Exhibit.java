...
public class Exhibit implements Serializable {
    ...
    public Exhibit(Integer id, String title, String image, Integer status, String content, Integer artist, String year) {
        this.id = id;
        this.title = title;
        this.image = image;
        this.status = status;
    ...
    public boolean equals(Object o) {
        ...
        Exhibit arts = (Exhibit) o;
        return Objects.equals(getId(), arts.getId()) && Objects.equals(getTitle(), arts.getTitle()) && Objects.equals(getImage(), arts.getImage()) && Objects.equals(getStatus(), arts.getStatus()) && Objects.equals(getContent(), arts.getContent()) && Objects.equals(getArtistId(), arts.getArtistId()) && Objects.equals(getYear(), arts.getYear());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getTitle(), getImage(), getStatus(), getContent(), getArtistId(), getYear());
    }
